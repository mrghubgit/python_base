...
# TODO В данном случае я понимаю что команда elif не нужна?
...
if hole_x > brick_x and hole_y > brick_y:
    ...
    print('Нет')
# TODO Только не могу понять как еще проверить brick_z, как будто слишком просто получилось,
#  не зря же его указали