...
# TODO 4 и 5 слова надо получить за один срез
# TODO Важно понимать, что шаг, который задаётся третьим числом, используется при прохождении по диапазону
# TODO Так с шагом 1 мы можем проти по диапазону от 1 до 5  (1 + 1 = 2... 4 + 1 = 5)
# TODO А с шагом -1 по этому же диапазону от 1 до 5 мы уже пройти не сможем (1 + (-1) = 0, 0 + (-1) = -1...)
# TODO Поэтому во втором случае надо будет поменять местами индексы - от 5 до 1