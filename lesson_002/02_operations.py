...
#TODO Получилось больше коммитов чем планировал, еще эксперементировал с удалением и изменением коммита. Вопрос для ясности, получается коммитить надо когда все задания выполнил? Или можно по одному?